...
\begin{frame}{Teorema do Corte: D-E}
  \begin{columns}
    ...
    \begin{figure}[ht]
      \centering
      \resizebox{\textwidth}{!}{\input{fig/d_de.tex}}
    \end{figure}
    \column{.65\textwidth}
    \scriptsize
    \centering
...
\begin{frame}{Análise da Segunda Estrutura}
  \begin{figure}[ht]
    \centering
    \resizebox{.75\textwidth}{!}{\input{fig/d4.tex}}
  \end{figure}
\end{frame}
...
\begin{frame}{Equações de Equilíbrio}
  \begin{columns}
    ...
    \begin{figure}[ht]
      \centering
      \resizebox{\textwidth}{!}{\input{fig/d4.tex}}
    \end{figure}
  \end{columns}
\end{frame}
...
\begin{frame}{Teorema do Corte: B-D}
  \begin{columns}
    ...
    \begin{figure}[ht]
      \centering
      \resizebox{\textwidth}{!}{\input{fig/d_bd.tex}}
    \end{figure}
    \column{.65\textwidth}
    \scriptsize
    \centering
...
\begin{frame}{Teorema do Corte: C-D}
  \begin{columns}
    ...
    \begin{figure}[ht]
      \centering
      \resizebox{\textwidth}{!}{\input{fig/d_cd.tex}}
    \end{figure}
    \column{.65\textwidth}
    \scriptsize
    \centering
...
\begin{frame}{Diagrama do Momento Fletor}
  \begin{figure}[ht]
    \centering
    \resizebox{.75\textwidth}{!}{\input{fig/momento.tex}}
  \end{figure}
\end{frame}
