...
\abstract{
  Neste relatório é mostrado os principais resultados do primeiro exercício programa
}
...
\begin{figure}[!ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[height=140mm]{p1_equipotenciais} &
    \includegraphics[height=140mm]{p2_equipotenciais}
  \end{tabular}
