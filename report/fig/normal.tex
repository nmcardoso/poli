\begin{tikzpicture}
  \begin{scope}
    ...
    \dnotation{1}{a}{A}[right=2mm];
    \dnotation{1}{b}{B}[right=2mm];
    \dnotation{1}{c}{C}[above right];
    \dnotation{1}{d}{D}[above right];
    \dnotation{1}{e}{E}[below=2mm];

    \internalforces{a}{e}{1}{1}[0][blue!70];
    \internalforces{d}{e}{-1}{-1}[0][blue!70];
    \internalforces{b}{d}{1}{1}[0][blue!70];
    \internalforces{c}{d}{-1}{-1}[0][blue!70];
  \end{scope}
\end{tikzpicture}