...
\begin{figure}[h!]
  \centering
  \resizebox{.7\textwidth}{!}{\input{fig/d2.tex}}
  \smallskip
...
\begin{minipage}{.45\textwidth}
  \begin{minipage}{.7\textwidth}
    \centering
    \resizebox{\linewidth}{!}{\input{fig/conv_solicitantes.tex}}
    (a)
  \end{minipage}%
  \hfill%
  \begin{minipage}{.25\textwidth}
    \centering
    \resizebox{\linewidth}{!}{\input{fig/conv_grinter.tex}}
    (b)
  \end{minipage}
...
\begin{figure}[h!]
  \centering
  \resizebox{.5\linewidth}{!}{\input{fig/d3.tex}}
...
\begin{figure}[h!]
  \centering
  \resizebox{.5\textwidth}{!}{\input{fig/d4.tex}}
...
\begin{minipage}{.35\textwidth}
  \centering
  \resizebox{\linewidth}{!}{\input{fig/d_ae.tex}}
...
\begin{minipage}{.52\textwidth}
  \centering
  \resizebox{\linewidth}{!}{\input{fig/r_ae.tex}}
...
\begin{minipage}{.35\textwidth}
  \centering
  \resizebox{\linewidth}{!}{\input{fig/d_de.tex}}
...
\begin{minipage}{.52\textwidth}
  \centering
  \resizebox{\linewidth}{!}{\input{fig/r_de.tex}}
...
\begin{minipage}{.35\textwidth}
  \centering
  \resizebox{\linewidth}{!}{\input{fig/d_bd.tex}}
...
\begin{minipage}{.52\textwidth}
  \centering
  \resizebox{\linewidth}{!}{\input{fig/r_bd.tex}}
...
\begin{minipage}{.35\textwidth}
  \centering
  \resizebox{\linewidth}{!}{\input{fig/d_cd.tex}}
...
\begin{minipage}{.52\textwidth}
  \centering
  \resizebox{\linewidth}{!}{\input{fig/r_cd.tex}}
...
\begin{minipage}{.45\textwidth}
  \resizebox{\textwidth}{!}{\input{fig/normal.tex}}
  \captionof{figure}{Força normal.}
  \label{fig:gr-normal}
\end{minipage}%
\hfill%
\begin{minipage}{.45\textwidth}
  \resizebox{\textwidth}{!}{\input{fig/cortante.tex}}
  \captionof{figure}{Força cortante.}
  \label{fig:gr-cortante}
\end{minipage}
...
\begin{figure}[ht!]
  \centering
  \resizebox{.45\textwidth}{!}{\input{fig/momento.tex}}
  \caption{Momento fletor.}
  \label{fig:gr-momento}
\end{figure}
